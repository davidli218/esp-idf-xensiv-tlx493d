...
#ifndef TLX493D_G3_COMMON_H
#define TLX493D_G3_COMMON_H
...
void tlx493d_gen_3_calculateRawTemperature(
    TLx493D_t* sensor, uint8_t tempMSBBF, uint8_t tempLSBBF, int16_t* temperature
);
void tlx493d_gen_3_calculateRawMagneticField(
    TLx493D_t* sensor,
...
void tlx493d_gen_3_calculateTemperature(
    TLx493D_t* sensor, uint8_t tempMSBBF, uint8_t tempLSBBF, double* temperature
);
void tlx493d_gen_3_calculateMagneticField(
    TLx493D_t* sensor,
...
bool tlx493d_gen_3_setMeasurement(
    TLx493D_t* sensor, uint8_t channelBF, uint8_t channelSaveBF, TLx493D_MeasurementType_t val
);
bool tlx493d_gen_3_setTrigger(TLx493D_t* sensor, uint8_t trigBF, TLx493D_TriggerType_t val);
bool tlx493d_gen_3_setSensitivity(
    TLx493D_t* sensor, uint8_t shortBF, uint8_t xtrShortBF, TLx493D_SensitivityType_t val
);
...
bool tlx493d_gen_3_setWakeUpThresholdsAsInteger(
    TLx493D_t* sensor, uint8_t wuBF, uint8_t wucpBF, uint8_t wupBF,
...
bool tlx493d_gen_3_setWakeUpThresholds(
    TLx493D_t* sensor, uint8_t wuBF, uint8_t wucpBF, uint8_t wupBF,
    uint8_t xlMSBBF, uint8_t xlLSBBF, uint8_t xhMSBBF, uint8_t xhLSBBF,
    uint8_t ylMSBBF, uint8_t ylLSBBF, uint8_t yhMSBBF, uint8_t yhLSBBF,
    uint8_t zlMSBBF, uint8_t zlLSBBF, uint8_t zhMSBBF, uint8_t zhLSBBF,
...
double tlx493d_gen_3_getSensitivityScaleFactor(
    const TLx493D_t* sensor, TLx493D_AvailableSensitivityType_t availSens, uint8_t x2BF, uint8_t x4BF
);

void tlx493d_gen_3_calculateRawMagneticFieldAtTemperature(
