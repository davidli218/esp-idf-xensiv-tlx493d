 ...
 * @retval true Function execution was successful.
 */
bool tlx493d_getRawMagneticFieldAndTemperature(
 ...
 * @retval true Function execution was successful.
 */
bool tlx493d_hasValidData(const TLx493D_t* sensor);
 ...
 * @retval true Function execution was successful.
 */
bool tlx493d_isFunctional(const TLx493D_t* sensor);
 ...
 * @retval true Function execution was successful.
 */
bool tlx493d_hasWakeUp(const TLx493D_t* sensor);
 ...
 * @retval true Function execution was successful.
 */
bool tlx493d_isWakeUpEnabled(const TLx493D_t* sensor);
 ...
 * @retval true Function execution was successful.
 */
bool tlx493d_setWakeUpThresholdsAsInteger(
    TLx493D_t* sensor,
    int16_t xl_th, int16_t xh_th,
    int16_t yl_th, int16_t yh_th,
 ...
 * @retval true Function execution was successful.
 */
bool tlx493d_setWakeUpThresholds(
    TLx493D_t* sensor,
    double temperature,
...
/**
 * @brief The function `tlx493d_calculateRawMagneticFieldAtTemperature` calculates the raw magnetic field
 ...
 * @param[in]       xInmT       The parameter `xInmT` represents the magnetic field strength in Millitesla (mT) along the x-axis.
 * @param[in]       yInmT       The parameter `yInmT` represents the magnetic field strength in Millitesla (mT) along the y-axis.
 * @param[in]       zInmT       The parameter `zInmT` represents the magnetic field strength in Millitesla (mT) along the z-axis.
 * @param[in,out]   x           A pointer to a variable where the calculated raw magnetic field in the x-axis will be stored.
 * @param[in,out]   y           A pointer to a variable where the calculated raw magnetic field in the y-axis will be stored.
 * @param[in,out]   z           A pointer to a variable where the calculated raw magnetic field in the z-axis will be stored.
 */
void tlx493d_calculateRawMagneticFieldAtTemperature(
 ...
 * @param[in, out] sensor A pointer to a TLx493D_t structure, which represents the TLx493D sensor.
*/
void tlx493d_printRegisters(const TLx493D_t* sensor);
