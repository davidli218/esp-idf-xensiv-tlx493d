...
#include "tlx493d_g1_common_defines.h"
...
static TLx493D_Register_t TLx493D_A1B6_regDef[] = {
    /** Read registers. */
    {TLx493D_READ_MODE_e, 0x00, 0xFF, 0, 8}, /* A1B6_BX_MSB_e     */
    {TLx493D_READ_MODE_e, 0x01, 0xFF, 0, 8}, /* A1B6_BY_MSB_e     */
    {TLx493D_READ_MODE_e, 0x02, 0xFF, 0, 8}, /* A1B6_BZ_MSB_e     */
    {TLx493D_READ_MODE_e, 0x03, 0xF0, 4, 4}, /* A1B6_TEMP_MSB_e   */
    {TLx493D_READ_MODE_e, 0x03, 0x0C, 2, 2}, /* A1B6_FRM_e        */
    {TLx493D_READ_MODE_e, 0x03, 0x03, 0, 2}, /* A1B6_CH_e         */
    {TLx493D_READ_MODE_e, 0x04, 0xF0, 4, 4}, /* A1B6_BX_LSB_e     */
    {TLx493D_READ_MODE_e, 0x04, 0x0F, 0, 4}, /* A1B6_BY_LSB_e     */
    {TLx493D_READ_MODE_e, 0x05, 0x40, 6, 1}, /* A1B6_T_e          */
    {TLx493D_READ_MODE_e, 0x05, 0x20, 5, 1}, /* A1B6_FF_e         */
    {TLx493D_READ_MODE_e, 0x05, 0x10, 4, 1}, /* A1B6_PD_e         */
    {TLx493D_READ_MODE_e, 0x05, 0x0F, 0, 4}, /* A1B6_BZ_LSB_e     */
    {TLx493D_READ_MODE_e, 0x06, 0xFF, 0, 8}, /* A1B6_TEMP_LSB_e   */
    {TLx493D_READ_MODE_e, 0x07, 0x18, 3, 2}, /* A1B6_R_RES_1_e    */
    {TLx493D_READ_MODE_e, 0x08, 0xFF, 0, 8}, /* A1B6_R_RES_2_e    */
    {TLx493D_READ_MODE_e, 0x09, 0x1F, 0, 5}, /* A1B6_R_RES_3_e    */
    /** Write Registers. */
    {TLx493D_WRITE_MODE_e, 0x00, 0xFF, 0, 8}, /* A1B6_W_RES_0_e   */
    {TLx493D_WRITE_MODE_e, 0x01, 0x80, 7, 1}, /* A1B6_P_e         */
    {TLx493D_WRITE_MODE_e, 0x01, 0x60, 5, 2}, /* A1B6_IICADR_e    */
    {TLx493D_WRITE_MODE_e, 0x01, 0x18, 3, 2}, /* A1B6_W_RES_1_e   */
    {TLx493D_WRITE_MODE_e, 0x01, 0x04, 2, 1}, /* A1B6_INT_e       */
    {TLx493D_WRITE_MODE_e, 0x01, 0x02, 1, 1}, /* A1B6_FAST_e      */
    {TLx493D_WRITE_MODE_e, 0x01, 0x01, 0, 1}, /* A1B6_LOW_POWER_e */
    {TLx493D_WRITE_MODE_e, 0x02, 0xFF, 0, 8}, /* A1B6_W_RES_2_e   */
    {TLx493D_WRITE_MODE_e, 0x03, 0x80, 7, 1}, /* A1B6_Temp_NEN_e  */
    {TLx493D_WRITE_MODE_e, 0x03, 0x40, 6, 1}, /* A1B6_LP_e        */
    {TLx493D_WRITE_MODE_e, 0x03, 0x20, 5, 1}, /* A1B6_PT_e        */
    {TLx493D_WRITE_MODE_e, 0x03, 0x1F, 0, 5}  /* A1B6_W_RES_3_e   */
};
...
static TLx493D_A1B6_PowerModeCombinations_t TLx493D_A1B6_PowerModeCombinations[] = {
    ...
    {1, 1, 1, 10},   /** MASTER_CONTROL_LED_MODE */
};
...
bool TLx493D_A1B6_init(TLx493D_t* sensor) {
    return tlx493d_common_init(
        sensor, GEN_1_REG_MAP_SIZE, TLx493D_A1B6_regDef, &TLx493D_A1B6_commonFunctions,
        TLx493D_A1B6_e, TLx493D_I2C_e
    );
}
...
bool TLx493D_A1B6_readRegisters(TLx493D_t* sensor) {
    return tlx493d_transfer(
        sensor, NULL, 0, sensor->regMap, GEN_1_READ_REGISTERS_MAX_COUNT
    );
}
...
void TLx493D_A1B6_calculateRawTemperature(const TLx493D_t* sensor, int16_t* temperature) {
    tlx493d_common_calculateRawTemperature(
        sensor, A1B6_TEMP_MSB_e, A1B6_TEMP_LSB_e, temperature
    );
}
...
void TLx493D_A1B6_calculateRawMagneticField(const TLx493D_t* sensor, int16_t* x, int16_t* y, int16_t* z) {
    tlx493d_common_calculateRawMagneticField(
        sensor,
        A1B6_BX_MSB_e, A1B6_BX_LSB_e, A1B6_BY_MSB_e,
        A1B6_BY_LSB_e, A1B6_BZ_MSB_e, A1B6_BZ_LSB_e,
        x, y, z
    );
}
...
void TLx493D_A1B6_calculateTemperature(const TLx493D_t* sensor, double* temp) {
    ...
    *temp = ((double)value - GEN_1_TEMP_OFFSET) * GEN_1_TEMP_MULT + GEN_1_TEMP_REF;
}
...
bool TLx493D_A1B6_setMeasurement(TLx493D_t* sensor, const TLx493D_MeasurementType_t mVals) {
    uint8_t temp_nen = 0;
    ...
    switch (mVals) {
        ...
        default: tlx493d_errorSelectionNotSupportedForSensorType(sensor, mVals, "TLx493D_MeasurementType_t");
            return false;
    }
...
bool TLx493D_A1B6_setTrigger(const TLx493D_t* sensor, const TLx493D_TriggerType_t trig) {
    (void)trig;
...
bool TLx493D_A1B6_setSensitivity(const TLx493D_t* sensor, const TLx493D_SensitivityType_t sens) {
    (void)sens;
...
bool TLx493D_A1B6_setIICAddress(TLx493D_t* sensor, const TLx493D_IICAddressType_t addr) {
    ...
    TLx493D_A1B6_calculateConfigurationParity(sensor);
    const bool ret = TLx493D_A1B6_transferWriteRegisters(sensor);
...
bool TLx493D_A1B6_setUpdateRate(const TLx493D_t* sensor, const TLx493D_UpdateRateType_t rate) {
    (void)rate;
...
bool TLx493D_A1B6_hasValidFuseParity(const TLx493D_t* sensor) {
    const TLx493D_Register_t* bf = &sensor->regDef[A1B6_FF_e];
...
bool TLx493D_A1B6_hasValidTBit(const TLx493D_t* sensor) {
    const TLx493D_Register_t* bf = &sensor->regDef[A1B6_T_e];
    return ((sensor->regMap[bf->address] & bf->mask) == 0);
}
...
void TLx493D_A1B6_setReservedRegisterValues(const TLx493D_t* sensor) {
    TLx493D_A1B6_setBitfield(
        sensor, A1B6_W_RES_1_e, TLx493D_A1B6_returnBitfield(sensor, A1B6_R_RES_1_e)
    );
    TLx493D_A1B6_setBitfield(
        sensor, A1B6_W_RES_2_e, TLx493D_A1B6_returnBitfield(sensor, A1B6_R_RES_2_e)
    );
    TLx493D_A1B6_setBitfield(
        sensor, A1B6_W_RES_3_e, TLx493D_A1B6_returnBitfield(sensor, A1B6_R_RES_3_e)
    );
}
...
uint8_t TLx493D_A1B6_selectIICAddress(const TLx493D_t* sensor, const TLx493D_IICAddressType_t addr) {
    switch (addr) {
        ...
        default:
            tlx493d_errorSelectionNotSupportedForSensorType(sensor, addr, "TLx493D_IICAddressType_t");
            return 0;
    }
}
...
void TLx493D_A1B6_calculateRawMagneticFieldAtTemperature(
    ...
    const double xInmT, const double yInmT, const double zInmT,
...
uint8_t TLx493D_A1B6_returnBitfield(const TLx493D_t* sensor, const uint8_t bitField) {
...
void TLx493D_A1B6_setBitfield(const TLx493D_t* sensor, const uint8_t bitField, const uint8_t newBitFieldValue) {
    const TLx493D_Register_t* bf = &sensor->regDef[bitField];

    if (bf->accessMode == TLx493D_WRITE_MODE_e) {
        sensor->regMap[bf->address + GEN_1_WRITE_REGISTERS_OFFSET] = (
            (sensor->regMap[bf->address + GEN_1_WRITE_REGISTERS_OFFSET] & ~bf->mask)
            | (newBitFieldValue << bf->offset)
        );
    } else {
...
bool TLx493D_A1B6_transferWriteRegisters(TLx493D_t* sensor) {
    return tlx493d_transfer(
        sensor,
        sensor->regMap + GEN_1_WRITE_REGISTERS_OFFSET,GEN_1_WRITE_REGISTERS_MAX_COUNT,
        NULL, 0
    );
}
