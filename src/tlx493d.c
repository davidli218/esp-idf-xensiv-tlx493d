...
bool tlx493d_init(TLx493D_t* sensor, const TLx493D_SupportedSensorType_t sensorType) {
    switch (sensorType) {
...
bool tlx493d_getMagneticFieldAndTemperature(
...
bool tlx493d_setMeasurement(TLx493D_t* sensor, const TLx493D_MeasurementType_t meas) {
    return sensor->functions->setMeasurement(sensor, meas);
}

bool tlx493d_setTrigger(TLx493D_t* sensor, const TLx493D_TriggerType_t trigger) {
    return sensor->functions->setTrigger(sensor, trigger);
}

bool tlx493d_setSensitivity(TLx493D_t* sensor, const TLx493D_SensitivityType_t range) {
...
bool tlx493d_setIICAddress(TLx493D_t* sensor, const TLx493D_IICAddressType_t addr) {
...
bool tlx493d_setWakeUpThresholdsAsInteger(
    TLx493D_t* sensor,
    const int16_t xl_th, const int16_t xh_th,
    const int16_t yl_th, const int16_t yh_th,
    const int16_t zl_th, const int16_t zh_th
) {
